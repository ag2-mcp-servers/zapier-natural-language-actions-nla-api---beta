...
app = MCPProxy(
    ...
    version='1.0.0',
    servers=[{'url': 'https://nla.zapier.com'}],
)
...
def execute_app_action_endpoint(
    exposed_app_action_id: constr(pattern=r'^[A-Z0-9]{26}$'), body: ExecuteRequest = ...
):
    """
